...
def parse_option():
    ...
    # resnet-18_distill_pro_withkd_lincls_best.pth.tar
    parser.add_argument('--pretrained', default='..//data_check//checkpoint//resnet-18_distill_pro_withkd_lincls_best.pth.tar', type=str,
                         help='path to simsiam pretrained checkpoint')
